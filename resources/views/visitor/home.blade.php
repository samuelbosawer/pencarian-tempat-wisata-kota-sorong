...
<html lang="en">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="visitor/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Additional CSS Files -->
    <link rel="stylesheet" href="/visitor/assets/css/fontawesome.css">
    <link rel="stylesheet" href="/visitor/assets/css/templatemo-woox-travel.css">
    <link rel="stylesheet" href="/visitor/assets/css/owl.css">
    <link rel="stylesheet" href="/visitor/assets/css/animate.css">
...
<body>
                ...
                <div class="item">
                  <div class="row">
                    <div class="col-lg-4 col-sm-5">
                      <div class="image">
                        <img src="/visitor/assets/images/country-01.jpg" alt="">
                      </div>
                    </div>
              ...
              <div class="col-lg-12">
                <div class="item">
                  <div class="row">
                    <div class="col-lg-4 col-sm-5">
                      <div class="image">
                        <img src="/visitor/assets/images/country-02.jpg" alt="">
                      </div>
                    </div>
                    <div class="col-lg-8 col-sm-7">
                      <div class="right-content">
              ...
              <div class="col-lg-12">
                <div class="item last-item">
                  <div class="row">
                    <div class="col-lg-4 col-sm-5">
                      <div class="image">
                        <img src="/visitor/assets/images/country-03.jpg" alt="">
                      </div>
                    </div>
                    <div class="col-lg-8 col-sm-7">
                      <div class="right-content">
  ...
  <script src="/visitor/vendor/jquery/jquery.min.js"></script>
  <script src="/visitor/vendor/bootstrap/js/bootstrap.min.js"></script>

  <script src="/visitor/assets/js/isotope.min.js"></script>
  <script src="/visitor/assets/js/owl-carousel.js"></script>
  <script src="/visitor/assets/js/wow.js"></script>
  <script src="/visitor/assets/js/tabs.js"></script>
  <script src="/visitor/assets/js/popup.js"></script>
  <script src="/visitor/assets/js/custom.js"></script>
