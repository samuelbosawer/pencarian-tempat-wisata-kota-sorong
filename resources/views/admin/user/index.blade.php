...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="row ">
    <div class="col-12">
        ...
        <div class="card">
                <h5 class="card-header text-capitalize"> <i class="menu-icon tf-icons bx bx-user"></i>  Data User </h5>
                  ...
                  <table class="table table-bordered">
                    <thead class="">
                      <tr class="bg-primary ">
                        ...
                        <th class="text-white text-center  p-3 fw-bolder">TTL</th> 
                    ...
                    <tbody class="table-border-bottom-0">
                      @forelse($datas as $data )
                               <tr>
                        <td>{{ ++$i }}</td>
                        <td class="fw-bolder"> <a href="{{ route('dashboard.user.ubah', $data->id) }}">{{ $data->nama }}</a></td>
                        <td>{{ $data->email }}</td>
                        <td>{{ $data->tempat_lahir ?? '-' }}, {{ \Carbon\Carbon::parse($data->tanggal_lahir)->translatedFormat('d - m - Y') ?? '-' }}</td>
                        <td class="text-center">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="{{ route('dashboard.user.detail', $data->id) }}"
                                >
