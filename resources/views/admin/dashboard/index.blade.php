                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 mt-4">
                                <div class="card border-0 shadow-sm h-100 user-card-hover position-relative overflow-hidden">
                                    ...
                                    <div class="card-body text-center p-4 position-relative">
                                        ...
                                        <!-- Nama dan role -->
                                        <h5 class="card-title mb-1 text-dark fw-bold"> SKALA PENILAIAN </h5>
                                        <h3 class=" fw-bolder mb-3"> {{ $skala ?? '0'}}</h3>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 mt-4">
                                <div class="card border-0 shadow-sm h-100 user-card-hover position-relative overflow-hidden">
                                    ...
                                    <div class="card-body text-center p-4 position-relative">
                                        ...
                                        <!-- Nama dan role -->
                                        <h5 class="card-title mb-1 text-dark fw-bold"> PENILAIAN </h5>
                                        <h3 class=" fw-bolder mb-3"> {{ $penilaian ?? '0'}}</h3>
                                    ...
                                    <!-- Tombol action di bawah (opsional) -->
                                    <div class="card-footer bg-transparent border-0 text-center pt-0">
                                        <a href="{{ route('dashboard.penilaian') }}"
                                            class="btn btn-outline-primary btn-sm rounded-pill px-4">Lihat Detail</a>
                                    </div>
                                </div>
                            </div>
