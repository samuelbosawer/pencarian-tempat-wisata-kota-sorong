                    ...
                    <table class="table table-bordered">
                        <thead class="">
                            <tr class="bg-primary ">
                                ...
                                <th class="text-white text-center  p-3 fw-bolder" >Nama Wisata</th>
                                <th class="text-white text-center  p-3 fw-bolder" >Kategori</th>
                                <th class="text-white text-center  p-3 fw-bolder" >Foto Cover</th>
                                <th class="text-white text-center  p-3 fw-bolder"> Pemilik</th>
                            ...
                            @forelse($datas as $data)
                                <tr>
                                    ...
                                    <td class="fw-bolder"> <a
                                            href="{{ route('dashboard.wisata.ubah', $data->id) }}">{{ $data->nama_w }}</a>
                                    </td>
                                    <td>{{ $data->kategoriWisata->nama_ktg ?? '-' }} </td>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <form action="{{ route('dashboard.wisata.hapus', $data->id) }}"
                                                    method="POST"
