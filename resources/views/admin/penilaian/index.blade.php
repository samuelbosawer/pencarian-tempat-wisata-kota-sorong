...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="row ">
    <div class="col-12">
        ...
        <div class="card">
                <h5 class="card-header text-capitalize"> <i class="menu-icon tf-icons bx bx-message"></i>  Data Penilaian</h5>
                  ...
                  <table class="table table-bordered">
                    <thead class="">
                      <tr class="bg-primary ">
                        ...
                        <th class="text-white text-center  p-3 fw-bolder" width="50%">Nama User</th>
                        <th class="text-white text-center  p-3 fw-bolder" width="50%">Wisata</th>
                        <th class="text-white text-center  p-3 fw-bolder" width="50%">Saran</th>
                    ...
                    <tbody class="table-border-bottom-0">
                      @forelse($datas as $data )
                               <tr>
                        <td>{{ ++$i }}</td>
                        <td class="fw-bolder"> <a href="{{ route('dashboard.penilaian.detail', $data->id) }}">{{ $data->user->nama }}</a></td>
                        <td>{{ $data->wisata->nama_w }}</td>
                        <td>{{ $data->saran_p }}</td>
                        <td class="text-center">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="{{ route('dashboard.penilaian.detail', $data->id) }}"
                                >
