...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="row ">
    <div class="col-12">
        ...
        <div class="card">
                <h5 class="card-header text-capitalize"> <i class="menu-icon tf-icons bx bx-collection"></i>  Data Kriteria</h5>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody class="table-border-bottom-0">
                      @forelse($datas as $data )
                               <tr>
                        <td>{{ ++$i }}</td>
                        <td class="fw-bolder"> <a href="{{ route('dashboard.kriteria.detail', $data->id) }}">{{ $data->kriteria }}</a></td>
                        <td>{{ $data->bobot }}</td>
                        <td>{{ $data->jenis }}</td>
